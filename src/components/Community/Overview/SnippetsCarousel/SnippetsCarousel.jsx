...
export default function SingleLineGridList() {
  ...
  // all this should be done on the backend with different end-points.  Arrays broken down by company for snippets
  ...
  // This can all be done on the backend and make the app more efficient
