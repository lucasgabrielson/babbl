...
class UserPageAppBar extends React.Component {
  ...
  render() {
    const proxies = UserPageAppBar.Controller !== UserPageAppBar ? transformProxies(this.props.children) : {
          ...
          <div>
            <div data-collapse="medium" data-animation="default" data-duration={400} data-no-scroll={1} id="about" role="banner" className="af-class-navbar w-nav">
              <div className="w-container">
                ...
                <nav role="navigation" className="af-class-nav-menu w-nav-menu">
                  ...
                  <a href="#/" className="af-class-nav-link af-class-light" onClick={() => this.props.dispatch({ type: 'LOGOUT' })}>LogOut</a>
            ...
            <div className="af-class-subpage-header af-class-about-3">
              <div className="af-class-container w-container">
                <h2 data-ix="fade-in-on-load" className="af-class-subpage-title">Welcome, {this.props.user.username}!</h2>
                <div data-ix="fade-in-on-load-2" className="af-class-page-subtitle">Your ID is: {this.props.user.id}</div>
              </div>
              </div>
            </div>
        </span>
...
export default connect(mapStateToProps)(UserPageAppBar);
